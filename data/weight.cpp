...
double Weight::get(const std::string &k) { return scores_.at(k); }

bool Weight::empty() const { return scores_.empty(); }

bool Weight::empty() { return scores_.empty(); }
